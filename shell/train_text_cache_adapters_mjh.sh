...
CUDA_VISIBLE_DEVICES=3,4,5,6, /home/mingjiahui/anaconda3/envs/T2I/bin/accelerate launch --main_process_port 29590 sdxl_train_adapter_with_text_cache.py --pretrained_model_name_or_path=$MODEL_DIR \
                                                --in_json $META_FILE \
